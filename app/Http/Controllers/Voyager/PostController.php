...
class PostController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        /* Retriving tags */
        $post = Post::find($id);
        $tags = array_diff($post->existingTags()->pluck('name')->toArray(), $post->tagged->pluck('tag_name')->toArray());
        $remove_tags = $post->tagged->pluck('tag_name');
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'tags', 'remove_tags'));
    }
